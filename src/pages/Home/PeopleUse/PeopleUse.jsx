...
const PeopleUse = () => {
    return (
        <div className='bg-base-200 py-20 my-28 md:w-full sm:w-full container mx-auto rounded-xl'>
            <h2 className='lg:text-4xl font-semibold text-center mb-10'>Millions of people use: Magic ToyBox</h2>
            <div className='w-3/4 mx-auto grid lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1 gap-4'>
                <div className="card w-4/5 lg:w-60 lg:h-60 md:mx-4 sm:mx-3 mr-10 bg-green-200 shadow-lg">
                ...
                <div className="card w-4/5 lg:w-60 lg:h-60 md:mx-4 sm:mx-3 bg-base-100 mr-10 shadow-lg">
                    <figure className="pt-10">
                ...
                <div className="card w-4/5 lg:w-60 lg:h-60 md:mx-4 sm:mx-3 bg-yellow-100 mr-10 shadow-lg">
                    <figure className="pt-10">
